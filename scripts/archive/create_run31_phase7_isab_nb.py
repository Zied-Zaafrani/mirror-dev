"""Create the Phase 7 ISAB Lab Encoder Kaggle notebook."""
import json
...
cells.append(md_cell(
    "# MIRROR — Phase 7: ISAB (Set Attention) Lab Encoder\n\n"
    "**Objective:** Ablate the Set Transformer approach of encoding the lab vector as a set of present "
    "elements and learning complex inter-lab interactions via Induced Set Attention Blocks (ISAB).\n\n"
    "**Configs:**\n"
    "- `baseline_per_lab`: Standard `per_lab_attn`\n"
    "- `isab`: `isab` lab encoder\n"
))
...
cells.append(code_cell(
    ...
    "    ('--ablation no_ablation --lab_encoder_type isab', 'isab'),\n"
    "]\n"
))
...
out = Path("notebooks/train_kaggle_phase7_isab.ipynb")
