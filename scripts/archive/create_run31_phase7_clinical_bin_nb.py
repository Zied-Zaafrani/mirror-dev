"""Create the Phase 7 HSGNN Clinical Bin Kaggle notebook."""
import json
...
cells.append(md_cell(
    "# MIRROR — Phase 7: HSGNN Clinical Bin Lab Encoder\n\n"
    "**Objective:** Ablate the HSGNN approach of mapping lab values into discrete clinical bins "
    "(missing, low, normal, high) and embedding the bins directly, compared to Z-score "
    "multiplication.\n\n"
    "**Configs:**\n"
    "- `baseline_per_lab`: Standard `per_lab_attn`\n"
    "- `clinical_bin`: `clinical_bin` lab encoder\n"
))
...
cells.append(code_cell(
    ...
    "    ('--ablation no_ablation --lab_encoder_type clinical_bin', 'clinical_bin'),\n"
    "]\n"
))
...
out = Path("notebooks/train_kaggle_phase7_clinical_bin.ipynb")
