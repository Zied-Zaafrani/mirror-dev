"""Create the Phase 7 Lab Count Sweep Kaggle notebook."""
import json
...
cells.append(md_cell(
    "# MIRROR — Phase 7: Lab Count Sweep\n\n"
    "**Objective:** Evaluate performance sensitivity to the number of top lab tests included. "
    "We sweep from 18 labs down to 0 to measure the incremental value of adding more labs.\n\n"
    "**Configs:**\n"
    "- `baseline_18`: 18 labs (baseline)\n"
    "- `top_10`: 10 labs\n"
    "- `top_5`: 5 labs\n"
    "- `top_1`: 1 lab\n"
    "- `zero`: 0 labs (disabled)\n"
))
...
cells.append(code_cell(
    "# Define experiments\n"
    "EXPERIMENTS = [\n"
    "    ('--ablation no_ablation --num_labs 18', 'baseline_18_labs'),\n"
    "    ('--ablation no_ablation --num_labs 10', 'top_10_labs'),\n"
    "    ('--ablation no_ablation --num_labs 5', 'top_5_labs'),\n"
    "    ('--ablation no_ablation --num_labs 1', 'top_1_labs'),\n"
    "    ('--ablation no_ablation --num_labs 0', 'zero_labs'),\n"
    "]\n"
))
...
out = Path("notebooks/train_kaggle_phase7_lab_count.ipynb")
