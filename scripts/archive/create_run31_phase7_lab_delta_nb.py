"""Create the Phase 7 Sheetrit Lab Delta Kaggle notebook."""
import json
...
cells.append(md_cell(
    "# MIRROR — Phase 7: Sheetrit Lab Delta Encoder\n\n"
    "**Objective:** Ablate the Sheetrit 2023 approach of incorporating the temporal delta "
    "(current_zscore - previous_zscore) to modulate the lab embedding.\n\n"
    "**Configs:**\n"
    "- `baseline_per_lab`: Standard `per_lab_attn`\n"
    "- `lab_delta`: `per_lab_attn_delta`\n"
))
...
cells.append(code_cell(
    ...
    "    ('--ablation no_ablation --lab_encoder_type per_lab_attn_delta', 'lab_delta'),\n"
    "]\n"
))
...
out = Path("notebooks/train_kaggle_phase7_lab_delta.ipynb")
